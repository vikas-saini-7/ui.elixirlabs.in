  ...
  (
    {
      ...
      items = [
        ...
        { id: "login", label: "Login", level: 2 },
        { id: "registration", label: "Registration", level: 2 },
        { id: "password-reset", label: "Password Reset", level: 3 },

        { id: "authorization", label: "Authorization", level: 1 },
        { id: "role-based-access", label: "Role-Based Access", level: 2 },
